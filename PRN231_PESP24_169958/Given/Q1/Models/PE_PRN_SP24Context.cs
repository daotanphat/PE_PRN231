...
namespace Q1.Models
{
	public partial class PE_PRN_SP24Context : DbContext
	{
		public PE_PRN_SP24Context()
		{
		}

		public PE_PRN_SP24Context(DbContextOptions<PE_PRN_SP24Context> options)
			: base(options)
		{
		}
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<EmployeeProject>(entity =>
			{
				entity.HasKey(e => new { e.EmployeeId, e.ProjectId })
					.HasName("PK__Employee__6DB1E41C01852DD0");
			...
			modelBuilder.Entity<EmployeeSkill>(entity =>
			{
				entity.HasKey(e => new { e.EmployeeId, e.SkillId })
					.HasName("PK__Employee__172A46EF95A852A5");
